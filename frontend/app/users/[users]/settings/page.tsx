...
export default function SettingsPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen pb-24" style={{ background: "#0f0f1a", color: "#fff" }}>
            <div className="sticky top-0 z-30 flex items-center gap-3 px-4" style={{ background: "rgba(15,15,26,0.97)", borderBottom: "1px solid rgba(255,255,255,0.06)", paddingTop: 16, paddingBottom: 12 }}>
