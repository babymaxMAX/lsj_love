  ...
  return (
    <div className="flex flex-col min-h-screen pb-20" style={{ background: "#0f0f1a", color: "#fff" }}>
      <div className="px-4 py-6">
        ...
        <p className="text-sm text-white/5 mt-2">Настройки профиля</p>
        <a href={`/users/${userId}/profile`} className="text-purple-400 underline mt-4 block">
          Редактировать профиль (legacy)
        </a>
      </div>
