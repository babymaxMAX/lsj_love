...
def convert_user_entity_to_document(user: UserEntity) -> dict:
    return {
        ...
        "icebreaker_used": user.icebreaker_used or 0,
...
def convert_user_document_to_entity(user_document: Mapping[str, Any]) -> UserEntity:
    return UserEntity(
        ...
        icebreaker_used=int(user_document.get("icebreaker_used") or 0),
        last_superlike_grant=user_document.get("last_superlike_grant"),
        last_icebreaker_grant=user_document.get("last_icebreaker_grant"),
